...
SELECT customerName, country, state FROM customers WHERE country = 'USA' && state = 'CA';
...
SELECT customerName, country, state, creditLimit FROM customers WHERE country = 'USA' && state = 'CA' && creditLimit > 100000;
...
SELECT customerName, country, creditLimit FROM customers WHERE country IN('USA', 'France') && creditLimit > 100000;
